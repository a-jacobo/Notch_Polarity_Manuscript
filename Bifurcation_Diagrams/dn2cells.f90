!----------------------------------------------------------------------
!----------------------------------------------------------------------
!   gdn2cells.f90 - Two cells coupled by delta notch signaling
!----------------------------------------------------------------------
!----------------------------------------------------------------------
...
! Normally unused Jacobian arguments : IJAC, DFDU, DFDP (see manual)
  ...
  DOUBLE PRECISION N1,N2,D1,D2,I1,I2,HS1N,HS1D,HS2N,HS2D
  DOUBLE PRECISION g,gI,kc,kt,s0,N0,D0,I0,ln,ld
  ...
  HS1N = (1.d0/(1.d0+(I1/s0)**2.d0))+ln*((I1/s0)**2.d0)/(1.d0+(I1/s0)**2.d0)
  HS1D = (1.d0/(1.d0+(I1/s0)**2.d0))+ld*((I1/s0)**2.d0)/(1.d0+(I1/s0)**2.d0)
  HS2N = (1.d0/(1.d0+(I2/s0)**2.d0))+ln*((I2/s0)**2.d0)/(1.d0+(I2/s0)**2.d0)
  HS2D = (1.d0/(1.d0+(I2/s0)**2.d0))+ld*((I2/s0)**2.d0)/(1.d0+(I2/s0)**2.d0)

  F(1) = N0*HS1N-kc*N1*D1-kt*N1*D2-g*N1
  F(2) = D0*HS1D-kc*D1*N1-kt*D1*N2-g*D1
  F(3) = kt*N1*D2-gI*I1+I0

  F(4) = N0*HS2N-kc*N2*D2-kt*N2*D1-g*N2
  F(5) = D0*HS2D-kc*D2*N2-kt*D2*N1-g*D2
  F(6) = kt*N2*D1-gI*I2+I0
...
PAR(1:10) = (/ 1.d-1, 5.d-1, 5.d-4, 2.d-4, 2.d2, 5.d2, 1.d3, 0.d0, 2.d0, 0.d0 /)
